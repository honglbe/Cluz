package com.jc.cluz.driver.selenium.impl;

import com.jc.cluz.driver.common.*;
import com.jc.cluz.driver.selenium.*;
import com.jc.cluz.model.CluzFactory;
import com.jc.cluz.utils.*;
...
public class SeleActionsImpl implements SeleActions {
    ...
    public void openBrower(String url){
        ...
        String chromePath = rootPath + "/src/main/resources/chromedriver";
    ...
    public void openH5Url(String url){
        CluzFactory.cluzModel.setDriverType(1);
        try {
