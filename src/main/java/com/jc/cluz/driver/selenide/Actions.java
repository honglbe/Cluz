package com.jc.cluz.driver.selenide;
...
public interface Actions {
     ...
     * @return
     */
    String getText(String element, String... elementType);
     ...
     * @param element
     */
    void selectedRadio(String element, String... elementType);

    /**
     * 下拉选择框选择
     * @param element
     */
    void selectedOption(String element, String content, String... elementType);
