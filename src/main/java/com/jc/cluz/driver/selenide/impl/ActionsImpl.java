package com.jc.cluz.driver.selenide.impl;
...
public class ActionsImpl implements Actions {
    ...
    public void openUrl(String url){
        ...
        CluzFactory.cluzModel.setDriverType(0);
        Selenide.open(url);
    }
    ...
    public String getText(String element,String ... elementType){
        By elementLocator = isElementLoaded(element,elementTimeout,elementType);
        return Selenide.$(elementLocator).getText();
    ...
    public void selectedRadio(String element, String... elementType){
        By elementLocator = isElementLoaded(element,elementTimeout,elementType);
        Selenide.$(elementLocator).click();
    }

    public void selectedOption(String element, String content, String... elementType){
        By elementLocator = isElementLoaded(element,elementTimeout,elementType);
        Selenide.$(elementLocator).selectOptionByValue(content);
    }
